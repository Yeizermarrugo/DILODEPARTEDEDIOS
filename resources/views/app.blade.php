...
<head>
    ...
    $currentTitle = strlen($rawTitle) < 30 ? $rawTitle . ' | Dilo de parte de Dios' : $rawTitle;
        ...
        <link rel="stylesheet"
            href="https://fonts.googleapis.com/css2?family=Cormorant+Garamond:ital,wght@0,300;0,400;0,600;0,700;1,300;1,400;1,600&family=Instrument+Sans:wght@300;400;500;600&family=Lora:ital,wght@0,400;0,500;0,600;0,700;1,400;1,500&family=Playfair+Display:wght@700;800;900&family=Sora:wght@400;500;600&display=swap"
