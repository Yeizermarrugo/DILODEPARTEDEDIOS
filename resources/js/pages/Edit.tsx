...
export default function Edit({ className }: DevocionalesProps) {
    const { devocionales, estudios, categorias, filters } = usePage<PageProps>().props;
    ...
    interface PaginationProps {
        ...
        paramName: 'devocionales_page' | 'estudios_page';
    }

    const Pagination = ({ paginator, paramName }: PaginationProps) => {
        const goToPage = (paramName: 'devocionales_page' | 'estudios_page', page: number) => {
            router.get(
                '/devocionales-edit',
                {
                    search: form.data.search,
