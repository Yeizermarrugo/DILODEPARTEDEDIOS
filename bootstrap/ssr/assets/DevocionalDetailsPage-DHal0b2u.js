...
const DevocionalDetailsPage = ({ devocional }) => {
  ...
  return /* @__PURE__ */ jsxs("div", { className: "devocional", children: [
    ...
    /* @__PURE__ */ jsx(
      "section",
      {
        ...
        children: /* @__PURE__ */ jsx("p", { style: { fontSize: "20px", padding: "10px" }, dangerouslySetInnerHTML: { __html: devocionalContent } })
      }
    ),
...
export {
  DevocionalDetailsPage as default
};
